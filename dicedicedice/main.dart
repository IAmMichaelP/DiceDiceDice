        ...
        home: Consumer<AuthService>(
          builder: (context, auth, _) {
            return auth.user == null
                ? WelcomeScreen() // Show welcome screen if user is not logged in
                : HomeScreen(); // Show home screen if user is logged in
          },
        ),
        routes: {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(left: 41.0, right: 41, top: 5, bottom: 5),
